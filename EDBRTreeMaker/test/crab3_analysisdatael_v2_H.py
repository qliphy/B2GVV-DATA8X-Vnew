...
config.General.requestName   = 'singleEl-16H-N1'
...
config.Data.inputDataset = '/SingleElectron/Run2016H-PromptReco-v2/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleEl-16H-N1'
