...
config.General.requestName   = 'singleMuon-16E-v1'
...
#config.Data.inputDataset = '/SingleMuon/Run2016E-PromptReco-v2/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleMuon-16E-v1'
