...
config.General.requestName   = 'singleMuon-16G-v1'
...
#config.Data.inputDataset = '/SingleMuon/Run2016G-PromptReco-v1/MINIAOD'#Run2015D-PromptReco-v3/MINIAOD'
...
config.Data.outputDatasetTag = 'singleMuon-16G-v1'
